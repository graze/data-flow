...
namespace Graze\DataFlow\Test\Functional\Flow\File\Compression;

use Graze\DataFlow\Flow\File\Compression\CompressionType;
use Graze\DataFlow\Flow\File\Compression\CompressorFactory;
...
class CompressorFactoryTest extends FileTestCase
{
    ...
    public function testPassingNoneCompressionTypeThrowsException()
    {
        ...
        static::setExpectedException(
            'Graze\DataFlow\Flow\File\Compression\InvalidCompressionTypeException',
